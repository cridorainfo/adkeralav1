...
/** Keep GPS alive when screen dims, tab is hidden, or user switches apps — reliable via a
 *  foreground service when running as the Capacitor Android app, best-effort in a plain browser/PWA. */
